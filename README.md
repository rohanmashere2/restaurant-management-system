...
<div align="center">
| Selection Screen | Manager Home | Kitchen Display |
|:---:|:---:|:---:|
| _add screenshot_ | _add screenshot_ | _add screenshot_ |
 
| Waiter Menu | Checkout | Bill History |
|:---:|:---:|:---:|
| _add screenshot_ | _add screenshot_ | _add screenshot_ |
 
</div>
> Drop your screenshots into an `assets/screenshots/` folder and replace the placeholders above with `![Label](assets/screenshots/file.png)`.
